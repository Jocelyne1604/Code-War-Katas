...
function shark(pontoonDistance, sharkDistance, youSpeed, sharkSpeed, dolphin) {
  let meToShore = pontoonDistance / youSpeed;
  let sharkToShore = (sharkDistance + pontoonDistance) / sharkSpeed;
  console.log("meToShore " + meToShore);
  console.log("sharkToShore " + sharkToShore);
  if (meToShore > sharkToShore) {
    return "Alive!";
  }
  return "Shark Bait!";
}
